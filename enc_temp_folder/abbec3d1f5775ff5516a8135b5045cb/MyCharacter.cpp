...
bool AMyCharacter::Server_Dive_Validate()
{
	return launchForce <= maxLaunchForce;
}
...
bool AMyCharacter::Server_Push_Validate(ACharacter* TargetCharacter)
{
	return pushDistance <= maxPushDistance;
}
